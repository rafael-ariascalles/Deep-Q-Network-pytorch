...
BUFFER_SIZE = int(100000)   # replay buffer size - Mantain
BATCH_SIZE = 64             # minibatch size - Mantain
GAMMA = 0.99                # discount factor - Mantain
TAU = 0.01                  # for soft update of target parameters - inc TAU
